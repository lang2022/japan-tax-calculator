window.CALCULATOR_MESSAGES = {
  pageTitle: "2026 日本 消費税 還付計算機 - 免税額をかんたん試算 | RefundJapan",
  heroTitle: "2026 日本 消費税 還付計算機",
  heroDesc: "リアルタイム為替とデパート手数料を踏まえた概算です。結果は参考値としてご利用ください。",
  auth: "公的ルールに基づく試算",
  upd: "更新日: 2026年9月",
  amt: "購入総額",
  incl: "税込価格",
  ...
  adv0: "金額を入力すると還付額の目安とアドバイスが表示されます",
  adv1: "アドバイス: 還付額が少なめのため、行列が長い場合は見送りも検討できます",
  adv2: "アドバイス: 還付額が見合うため、還付手続きの待機を推奨します",
  adv3: "アドバイス: 還付額が大きいため、還付手続きを受けましょう！",
  adRate: "免税の目安",
  adJpy: "同日・同店で",
  shareL: "LINEで共有",
  seo: `<h2>2026 年 日本消費税還付に関するよくあるご質問</h2>
    ...
    <h3>関連ガイドとツール</h3>
    <ul>
      <li><a href="/ja/guide/how-to-calculate/">日本の還付額の計算方法</a></li>
      <li><a href="/ja/guide/department-store-fee/">百貨店の手数料と還付額の関係</a></li>
      <li><a href="/ja/guide/minimum-maximum/">免税の最低金額と上限の目安</a></li>
      <li><a href="/ja/guide/common-mistakes/">免税でよくある間違い</a></li>
      <li><a href="/ja/tools/compare/">レジ分割と一括支払いの比較ツール</a></li>
      <li><a href="/ja/tools/shopping-list/">免税ショッピングリスト作成ツール</a></li>
    </ul>
