window.CALCULATOR_MESSAGES = {
  ...
  store: "매장 유형",
  store1: "일반 매장",
  store1d: "100% 환급 (수수료 없음)",
  store2: "백화점",
  store2d: "약 1.55% 수수료 공제",
  res: "예상 실제 환급액",
  curTarget: "KRW",
  curName: "KRW 원",
  copyBtn: "링크 복사",
  ...
  seo: `<h2>일본 소비세 환급 FAQ (2026)</h2>
    ...
    <div class="authority-module">
      ...
      <p><small>참고: 정책은 업데이트될 수 있습니다. 위 공식 링크가 가장 정확한 정보를 제공합니다.</small></p>
    </div>`,
  footer: "계산 결과는 참고용입니다. 실제 환급액은 점포 카운터에서 결제 시 기준으로 결정됩니다.",
  linkAbout: "정보",
